...
const Navbar = () => {
  ...
  const handleCartClick = () => {
    navigate("/yourcart"); // Navigate to the '/yourcart' route
  };
    ...
    <nav className="bg-rebel-dark text-rebel-light py-4 px-6 fixed w-full z-50 border-b border-rebel-light/20">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          <FiShoppingCart
            className="w-6 h-6 cursor-pointer hover:text-orange-500 transition-colors"
            onClick={handleCartClick} // Attach the click handler
          />
          <button
            className="md:hidden"
